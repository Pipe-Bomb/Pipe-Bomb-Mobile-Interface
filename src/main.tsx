...
const midnight = createTheme({
  ...
  theme: {
    colors: {
      primaryLight: '#ff5500',
      primaryLightHover: '#ff5500',
      primaryLightActive: '#ff5500',
      primaryLightContrast: '#ff3300',
      primaryAlpha: 'rgba(74, 222, 123, 0.2)',
      primary: '#ff5500',
      primaryBorder: '#ff5500',
      primaryBorderHover: '#ff3300',
      primarySolidHover: '#ff3300',
      primarySolidContrast: '$white',
      primaryShadow: '#ff3300',

      gradient: 'linear-gradient(112deg, #ff5500 -25%, #ff3300 80%)',
      link: '#5E1DAD',
